    ...
    function widgetDirective($controller, $http, $templateCache, $compile, widgetManager, $modal, WidgetState, DisplayState, $interval, dashboardData,$cookies) {
        ...
        function link(scope, element, attrs, containerController) {
            ...
            function processWidget(configFromApi, widgetConfig, dashboard) {
                ...
                console.log("widgetConfig.."+angular.toJson(scope.widgetConfig));
...
//                    }
                    console.log('New Widget Config', angular.toJson($scope.widgetConfig));
                    console.log("$rootScope.widgetConfig.componenetId..////"+angular.toJson($scope.widgetConfig.componentId));
                    $rootScope.widgetConfig = $scope.widgetConfig;
                    $rootScope.componentId = $rootScope.widgetConfig.componentId;
                    dashboardData
